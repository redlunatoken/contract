 ...
 * 10% Fee is Automatically added to Liquidity Pool.
...
contract REDLUNA01 is Context, IERC20, Ownable {
    ...
    string private _name = "Redluna";
    string private _symbol = "RedLuna";
    ...
    address public marketingWallet = 0xb9AbA492f754fB1808F2CD7586A71d504B3f7932;
    ...
    uint256 public _maxTxAmount = 20 * 10**10 * 10**9; // 20%  //  
